...
contract DeliberacoesConselhoAdm {
    ...
    function ArquivarAta(string memory paramPauta, string memory paramDecisao, string memory paramData, string memory paramParticipantes, string memory paramCapitalSocial, string memory paramtipoAta, string memory paramNumeroAta) public {
        AtadeReuniao memory novaAta = AtadeReuniao(paramPauta, paramDecisao, paramData, paramParticipantes, paramCapitalSocial, paramtipoAta, paramNumeroAta);
        book1.push(novaAta);
    ...
    function ConsultaDeliberacoesConselho(uint numeroAta) public view returns (string memory, string memory, string memory, string memory, string memory, string memory, string memory) {
        ...
        return (atadeReuniao.pauta, atadeReuniao.decisao, atadeReuniao.data, atadeReuniao.participantes, atadeReuniao.capitalSocial, atadeReuniao.tipoAta, atadeReuniao.numeroAta);
    }
